...
def MixNet(x):
    ...
    w13 = tf.Variable(tf.truncated_normal((2,2,4,8),0,s),'w13')
    b13 = tf.Variable(tf.truncated_normal([8],0,0.001),'b13')
    
    c1 = tf.nn.conv2d(c1,w13, strides = [1,2,2,1], padding='VALID') + b13
    ...
    #10x10x16 -> 5x5x16
    w23 = tf.Variable(tf.truncated_normal((2,2,8,16),0,s),'w23')
